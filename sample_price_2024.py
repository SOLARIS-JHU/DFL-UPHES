...
# Load price data
def load_price_data(file_path="./Data/Belgium.csv", year=2024):
...
def visualize_clusters(X_scaled, labels, medoids, dates, medoids_idx, X_original):
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("./Data/cluster_visualization_2024.png", dpi=300)
        plt.close()
    ...
    try:
        ...
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
        plt.tight_layout()
        plt.savefig("./Data/medoid_profiles_scaled_2024.png", dpi=300)
        plt.close()
        ...
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
        plt.tight_layout()
        plt.savefig("./Data/medoid_profiles_original_2024.png", dpi=300)
        plt.close()
    except Exception as e:
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("./Data/cluster_sizes_2024.png", dpi=300)
        plt.close()
    except Exception as e:
        print(f"Error generating cluster size plot: {e}")

# Build price database
def build_price_database(file_path="./Data/Belgium.csv", year=2024, n_clusters=20):
    """
...
def save_database_to_csv(database, file_path="./Data/price_data_2024.csv"):
    """Save the database to a CSV file"""
    rows = []
...
if __name__ == "__main__":
    ...
    try:
        ...
        database, labels, dates = build_price_database("./Data/Belgium.csv", year=2024, n_clusters=n_clusters)
        ...
        # Save the database to a CSV file
        save_database_to_csv(database, "./Data/price_data_2024.csv")
