...
def train_single_model(data_type, noise_level, file_path, architecture, num_layers, max_iterations, date_str, date_data, start_timestamp):
    ...
    try:
        ...
        if data_type == 'random_samples':
            source_name = "MIQP_linear_results_random_samples"
        else:  # relative_noise
            source_name = f"MIQP_linear_results_relative_noise_{int(noise_level*100):02d}pct"
...
def pretraining_with_grid_search():
    ...
    for noise_level in noise_levels:
        file_path = f"MIQP_linear_results_relative_noise_{int(noise_level*100):02d}pct.csv"
        source_name = f"MIQP_linear_results_relative_noise_{int(noise_level*100):02d}pct"
    ...
    random_samples_file = "MIQP_linear_results_random_samples.csv"
    random_samples_source = "MIQP_linear_results_random_samples"
