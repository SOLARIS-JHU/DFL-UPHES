...
def main_noise_insertion():
    ...
    if not os.path.exists(original_file):
        ...
        print("Please make sure the file exists in the MIQP/MIQP_piecewise directory.")
        return
    ...
    for noise_level in noise_levels:
        ...
        try:
            ...
            if final_df is not None:
                ...
                output_filename = f"MIQP_piecewise_results_relative_noise_{noise_level*100:.0f}pct.csv"
...
def main_random_sampling(num_samples_per_day=1):
    ...
    if final_df is not None:
        # Save results
        if num_samples_per_day == 1:
            output_filename = "MIQP_piecewise_results_random_samples.csv"
        else:
            output_filename = f"MIQP_piecewise_results_random_samples_{num_samples_per_day}x.csv"
...
def compare_all_methods():
    ...
    random_filename = "MIQP_piecewise_results_random_samples.csv"
