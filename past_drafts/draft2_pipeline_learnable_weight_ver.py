...
class OptiLayer:
    ...
    def forward(self, DA_prices, c, d, e, a, b, power, head, flow, w_p, w_h, w_q):
        ...
        return p_opt_thresholded, q_opt_thresholded, h_opt, v_opt
...
if __name__ == "__main__":
    ...
    # Print the first few coefficients for reference
    print("\nSample of precomputed coefficients used:")
    print("c (first 3 hours):", c[:3].detach().numpy().round(4))
    print("d (first 3 hours):", d[:3].detach().numpy().round(4))
    print("e (first 3 hours):", e[:3].detach().numpy().round(4))
    print("a (first 3 hours):", a[:3].detach().numpy().round(4))
    print("b (first 3 hours):", b[:3].detach().numpy().round(4))
